# Generated by Django 4.1 on 2023-12-03 16:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('songName', models.CharField(db_column='songName', max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('userId', models.CharField(db_column='userId', max_length=12, primary_key=True, serialize=False)),
